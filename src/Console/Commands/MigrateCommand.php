...
#[AsCommand(name: 'rinvex:migrate:settings')]
class MigrateCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'rinvex:migrate:settings {--f|force : Force the operation to run when in production.}';
     ...
     * @var string
     */
    protected $description = 'Migrate Rinvex Settings Tables.';
